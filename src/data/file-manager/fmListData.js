...
export const data = [
    ...
    },
    {
        id: 3,
        starred: false,
        name: [{ icons: "folder-2-fill", iconBg: "warning", fileName: "Laxera - HTML - v1.0", fileType: "folder" }],
    ...
    },
    {
        id: 4,
        starred: false,
        name: [{ icons: "folder-zip-fill", iconBg: "blue", fileName: "laxera.zip", fileType: "zip" }],
    ...
    },
    {
        id: 5,
        starred: true,
        name: [{ icons: "folder-5-fill", iconBg: "warning", fileName: "Laxera", fileType: "folder" }],
        sharing: [{ blank: true }],
